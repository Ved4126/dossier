...
export function CaseCard({
  ...
  const resumeText = app.resumeFileName || "no resume linked";
      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <h3 className="font-typewriter text-xl text-ink leading-tight mt-1">
              {app.company}
            </h3>
        ...
        <div className="mt-4 pt-3 border-t border-dashed border-paper-edge">
          <div className="flex items-center gap-2 text-xs text-ink-soft">
            ...
            <span className="font-typewriter truncate">{resumeText}</span>
          </div>

          <p className="font-hand text-stamp/80 text-sm mt-1">
            the exact resume you sent →
          </p>
        </div>
