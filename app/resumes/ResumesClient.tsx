      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {resumes.map((r, i) => (
          <div
            ...
            style={{
              ["--tilt" as string]: `${[-1.5, 1, -1, 1.5][i % 4]}deg`,
...
function SmallBtn({
  ...
  return (
    <button
      className={`inline-flex items-center gap-1.5 font-typewriter text-[10px] uppercase tracking-widest px-2.5 py-1.5 rounded-sm transition border ${
        danger
