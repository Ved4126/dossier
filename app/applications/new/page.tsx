...
export default function NewCase() {
  ...
  async function submit(e: FormEvent<HTMLFormElement>) {
    ...
    if (!company || !role || !jobDescription || !appliedDate) {
      alert("Please fill in company, role, job description, and applied date.");
      return;
    }
    ...
    <div className="max-w-3xl mx-auto">
      ...
      >
        ...
        <div className="flex gap-3 pt-2">
          <button
            type="submit"
            className="font-typewriter uppercase tracking-widest text-sm bg-stamp text-paper px-6 py-3 rounded-sm hover:bg-stamp-dark transition shadow"
          >
            Save Case
          </button>
